            ...
            <?php foreach($galeri as $ga){ ?>
				<div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.1s">
					<div class="blog-item bg-light rounded p-4" style="background-image: url(img/bg.png);">
						<div class="mb-4">
							<h4 class="text-primary mb-2"><?= $ga['judul'] ?></h4>
							<div class="d-flex justify-content-between">
								<!-- <p class="mb-0"><span class="fa fa-user text-primary"></span> <?= $ga['judul'] ?></p> -->
								<!-- <p class="mb-0"><span class="fa fa-folder text-primary"></span> <?= $ga['tanggal'] ?></p> -->
							</div>
						</div>
						<div class="project-img">
							<img src="<?= base_url('assets/upload/galeri/'.$ga['foto']) ?>" class="img-fluid w-100 rounded"
								alt="Image">
							<!-- <div class="blog-plus-icon">
								<a href="<?= base_url('assets/upload/galeri/'.$ga['foto']) ?>" data-lightbox="blog-1"
